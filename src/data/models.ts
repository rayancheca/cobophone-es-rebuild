...
export const models: Model[] = [
  ...
  { id: 'iphone-13', brandId: 'apple', brandSlug: 'apple', slug: 'iphone-13', name: 'iPhone 13', year: 2021, image: '/models/iphone-13.jpg', repairTypes: ['pantalla','bateria','conector-carga','camara','tapa-trasera','agua','altavoz','microfono','vibrador','sensor-proximidad','biometria','antena-wifi','botones','liberacion-sim','recuperacion-datos','sistema-operativo'], popularityScore: 86, msrpAtRelease: 909 },
  ...
  { id: 'galaxy-s23', brandId: 'samsung', brandSlug: 'samsung', slug: 'galaxy-s23', name: 'Galaxy S23', year: 2023, image: '/models/galaxy-s23.jpg', repairTypes: ['pantalla','bateria','conector-carga','camara','tapa-trasera','agua','altavoz','microfono','vibrador','sensor-proximidad','biometria','antena-wifi','botones','liberacion-sim','recuperacion-datos','sistema-operativo'], popularityScore: 92, msrpAtRelease: 859 },
